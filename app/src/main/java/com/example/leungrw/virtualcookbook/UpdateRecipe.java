...
public class UpdateRecipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textSearch = findViewById(R.id.TextViewSearchText);
        textSearch.setText("Tap on recipe for more info and to update");
        ...
        childEventListener = new ChildEventListener(){
            ...
            results.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent = new Intent(UpdateRecipe.this, com.example.leungrw.virtualcookbook.ViewDetails.class);
                    ...
                    intent.putExtra("previous","update");
